...
RSpec.describe ValidatorsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all validators as @validators" do
      ...
      expect(assigns(:validators)).to eq([validator])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested validator as @validator" do
      ...
      expect(assigns(:validator)).to eq(validator)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new validator as @validator" do
      ...
      expect(assigns(:validator)).to be_a_new(Validator)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created validator as @validator" do
        post :create, {:validator => valid_attributes}, valid_session
        expect(assigns(:validator)).to be_a(Validator)
        expect(assigns(:validator)).to be_persisted
      end

      it "redirects to the created validator" do
        post :create, {:validator => valid_attributes}, valid_session
        expect(response).to redirect_to(Validator.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved validator as @validator" do
        post :create, {:validator => invalid_attributes}, valid_session
        expect(assigns(:validator)).to be_a_new(Validator)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested validator" do
        validator = Validator.create! valid_attributes
        put :update, {:id => validator.to_param, :validator => new_attributes}, valid_session
        validator.reload
      ...
      it "redirects to the validator" do
        validator = Validator.create! valid_attributes
        put :update, {:id => validator.to_param, :validator => valid_attributes}, valid_session
        expect(response).to redirect_to(validator)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the validator as @validator" do
        validator = Validator.create! valid_attributes
        put :update, {:id => validator.to_param, :validator => invalid_attributes}, valid_session
        expect(assigns(:validator)).to eq(validator)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the validators list" do
      validator = Validator.create! valid_attributes
      delete :destroy, {:id => validator.to_param}, valid_session
      expect(response).to redirect_to(validators_url)
    end
  end
